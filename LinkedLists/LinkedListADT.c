...
/* @stuctures within LinkedListAPI.h
**Structure for Nodes used in a doubly linked list, using a void variable to be able to hold any form of information
...
**Structure for the layout of the linked list
@deleteNode this is used so that a custom deletion can be made that changes based on the data within the data variable 
@compare this is used so that a custom comparison between values stored in data can be made based on the data type 
@printNode this is used to print the values within data variable in the node
